...
open class JellyBeanSpanFixTextView : AppCompatTextView {
    private class FixingResult private constructor(val fixed: Boolean, val spansWithSpacesBefore: List<Any>?,
                                                   val spansWithSpacesAfter: List<Any>?) {

        companion object {
            fun fixed(spansWithSpacesBefore: List<Any>?,
                      spansWithSpacesAfter: List<Any>?): FixingResult {
     ...
     */
    private fun fixSpannedWithSpaces(builder: SpannableStringBuilder, widthMeasureSpec: Int,
                                     heightMeasureSpec: Int) {
        val startFix = System.currentTimeMillis()
        val result = addSpacesAroundSpansUntilFixed(builder, widthMeasureSpec,
                heightMeasureSpec)
        if (result.fixed) {
    ...
    private fun addSpacesAroundSpansUntilFixed(builder: SpannableStringBuilder,
                                               widthMeasureSpec: Int, heightMeasureSpec: Int): FixingResult {
    ...
    @SuppressLint("WrongCall")
    private fun removeUnneededSpaces(widthMeasureSpec: Int, heightMeasureSpec: Int,
