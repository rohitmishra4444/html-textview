...
import org.sufficientlysecure.htmltextview.HtmlFormatter.formatHtml
...
class HtmlTextView : JellyBeanSpanFixTextView {
    ...
    fun setHtml(html: String, imageGetter: ImageGetter?) {
        text = formatHtml(html, imageGetter, clickableTableSpan, drawTableLinkSpan, onClickATagListener, indent, removeTrailingWhiteSpace)
        // make links work
